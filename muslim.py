...
def get(hadithNumber):
    ...
    returnList = []
    fullHadith = ''
    # with open('hadith/sahih_muslim_ahadith.utf8.csv',encoding='utf-8') as muslim:
    #     muslim = csv.reader(muslim)
    #     # fields = next(muslim)
    #     # print(muslim)
    ...
    #     # return returnList.append(types.InlineQueryResultArticle(lists[hadithNumber][0],lists[hadithNumber][0], types.InputTextMessageContent(lists[hadithNumber-1][1]+'\n Sahih Muslim Hadith-'+str(hadithNumber))))
    ...
    try:
        ...
        hadith = fullHadithContainer.find("div",class_="actualHadithContainer hadith_container_muslim")
